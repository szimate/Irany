...
?>
      <td><a class="action" href="<?php echo url_for('/data_manager/documents/show.php?id=' . h(u($id))); ?>">Megtekintés</a></td>
      <td><a class="action" href="<?php echo url_for('/data_manager/documents/edit.php?id=' . h(u($id))); ?>">Szerkesztés</a></td>
      <td><a class="action" href="<?php echo url_for('/data_manager/documents/delete.php?id=' . h(u($id))); ?>">Törlés</a></td>
    </tr>
  <?php } ?>
</table>
